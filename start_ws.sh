#!/bin/bash
cd ~/cryptodatabase/cryptocollect/logs

COMMAND1=(python ~/cryptodatabase/cryptocollect/scripts/bitfinex_bch.py)
COMMAND2=(python ~/cryptodatabase/cryptocollect/scripts/bitfinex_btc.py)
COMMAND3=(python ~/cryptodatabase/cryptocollect/scripts/bitfinex_dash.py)
COMMAND4=(python ~/cryptodatabase/cryptocollect/scripts/bitfinex_eos.py)
COMMAND5=(python ~/cryptodatabase/cryptocollect/scripts/bitfinex_etc.py)
COMMAND6=(python ~/cryptodatabase/cryptocollect/scripts/bitfinex_eth.py)
COMMAND7=(python ~/cryptodatabase/cryptocollect/scripts/bitfinex_iota.py)
COMMAND8=(python ~/cryptodatabase/cryptocollect/scripts/bitfinex_ltc.py)
COMMAND9=(python ~/cryptodatabase/cryptocollect/scripts/bitfinex_xlm.py)
COMMAND10=(python ~/cryptodatabase/cryptocollect/scripts/bitfinex_xmr.py)
COMMAND11=(python ~/cryptodatabase/cryptocollect/scripts/bitfinex_xrp.py)
COMMAND12=(python ~/cryptodatabase/cryptocollect/scripts/bitfinex_zrx.py)
COMMAND13=(python ~/cryptodatabase/cryptocollect/scripts/binance.py)
COMMAND15=(python ~/cryptodatabase/cryptocollect/scripts/okex.py)
COMMAND16=(python ~/cryptodatabase/cryptocollect/scripts/hitbtc_bch.py)
COMMAND17=(python ~/cryptodatabase/cryptocollect/scripts/hitbtc_btc.py)
COMMAND18=(python ~/cryptodatabase/cryptocollect/scripts/hitbtc_dash.py)
COMMAND19=(python ~/cryptodatabase/cryptocollect/scripts/hitbtc_eos.py)
COMMAND20=(python ~/cryptodatabase/cryptocollect/scripts/hitbtc_etc.py)
COMMAND21=(python ~/cryptodatabase/cryptocollect/scripts/hitbtc_eth.py)
COMMAND22=(python ~/cryptodatabase/cryptocollect/scripts/hitbtc_iota.py)
COMMAND23=(python ~/cryptodatabase/cryptocollect/scripts/hitbtc_ltc.py)
COMMAND24=(python ~/cryptodatabase/cryptocollect/scripts/hitbtc_xlm.py)
COMMAND25=(python ~/cryptodatabase/cryptocollect/scripts/hitbtc_xmr.py)
COMMAND26=(python ~/cryptodatabase/cryptocollect/scripts/hitbtc_xrp.py)
COMMAND27=(python ~/cryptodatabase/cryptocollect/scripts/hitbtc_zrx.py)
COMMAND28=(python ~/cryptodatabase/cryptocollect/scripts/bitstamp_bch.py)
COMMAND29=(python ~/cryptodatabase/cryptocollect/scripts/bitstamp_btc.py)
COMMAND30=(python ~/cryptodatabase/cryptocollect/scripts/bitstamp_eth.py)
COMMAND31=(python ~/cryptodatabase/cryptocollect/scripts/bitstamp_ltc.py)
COMMAND32=(python ~/cryptodatabase/cryptocollect/scripts/bitstamp_xrp.py)
COMMAND33=(python ~/cryptodatabase/cryptocollect/scripts/poloniex.py)
COMMAND34=(python ~/cryptodatabase/cryptocollect/scripts/cbpro.py)
