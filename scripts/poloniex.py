...
def on_message(mes):
    ...
    if message[2][0] == 121:
        if message[2][1] != currencies[0]:
            result = {"p": message[2][1], "lowest_ask": message[2][2], "highest_bid": message[2][3], "c": "BTC-USD", "t": datetime.datetime.utcnow()}
    ...
    if message[2][0] == 122:
        if message[2][1] != currencies[1]:
            result = {"p": message[2][1], "lowest_ask": message[2][2], "highest_bid": message[2][3], "c": "DASH-USD", "t": datetime.datetime.utcnow()}
            res = poloniex_coll.insert_one(result)
            print(result)
    ...
    if message[2][0] == 123:
        if message[2][1] != currencies[2]:
            result = {"p": message[2][1], "lowest_ask": message[2][2], "highest_bid": message[2][3], "c": "LTC-USD", "t": datetime.datetime.utcnow()}
            res = poloniex_coll.insert_one(result)
            print(result)
    ...
    if message[2][0] == 126:
        if message[2][1] != currencies[3]:
            result = {"p": message[2][1], "lowest_ask": message[2][2], "highest_bid": message[2][3], "c": "XMR-USD", "t": datetime.datetime.utcnow()}
            res = poloniex_coll.insert_one(result)
            print(result)
    ...
    if message[2][0] == 127:
        if message[2][1] != currencies[4]:
            result = {"p": message[2][1], "lowest_ask": message[2][2], "highest_bid": message[2][3], "c": "XRP-USD", "t": datetime.datetime.utcnow()}
            res = poloniex_coll.insert_one(result)
            print(result)
    ...
    if message[2][0] == 149:
        if message[2][1] != currencies[5]:
            result = {"p": message[2][1], "lowest_ask": message[2][2], "highest_bid": message[2][3], "c": "ETH-USD", "t": datetime.datetime.utcnow()}
            res = poloniex_coll.insert_one(result)
            print(result)
